return {
	...
	config = function()
		...
		vim.api.nvim_create_autocmd("FileType", {
			...
			callback = function()
				vim.keymap.set("n", "<C-i>", "<cmd>GoImport<CR>",
					{ buffer = true, desc = "Go: Add imports" })
				vim.keymap.set("n", "<C-b>", "<cmd>GoBuild<CR>",
					{ buffer = true, desc = "Go: Build package" })
				vim.keymap.set("n", "<C-t>", "<cmd>GoTestPkg<CR>",
					{ buffer = true, desc = "Go: Run tests" })
				vim.keymap.set("n", "<C-c>", "<cmd>GoCoverage -p<CR>",
					{ buffer = true, desc = "Go: Show coverage" })
